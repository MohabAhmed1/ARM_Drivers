...
#define PORTA_PIN8_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_10MHZ
...
#define PORTA_PIN12_MODE                   PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
...
#define PORTB_PIN3_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN4_MODE                    PORT_INPUT_FLOATING_MODE
#define PORTB_PIN5_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
...
#define PORTB_PIN12_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_10MHZ
#define PORTB_PIN13_MODE                   PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN14_MODE                   PORT_INPUT_FLOATING_MODE
#define PORTB_PIN15_MODE                   PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
